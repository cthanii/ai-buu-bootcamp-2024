...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ธนิสร สุขแสง คือ นักศึกษามหาวิทยาลัยบูรพา คณะวิทยาการสารสนเทศ สาขาวิชาAI ปีการศึกษา 2565",
        "ธนิสร สุขแสง มีชื่อเล่นว่า เชอ เกิดวันที่ 27 กันยายน 2546 ศึกษาจบจากโรงเรียนดัดดรุณี ที่จังหวัดฉะเชิงเทรา",
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 8:30 น. - 16:30 น. มีคนเข้าร่วม 50 คน",
        "ในทีม ClickNext team AI มี พี่เจ๋ง ทำน้าที่เป็น Dev, พี่ดาว ทำหน้าที่เป็น BA, พี่ออย ทำหน้าที่เป็น BA, พี่ปาล์ม ทำหน้าที่ Backend, และ พี่ชวน ทำหน้าที่ Dataops"
    ]
